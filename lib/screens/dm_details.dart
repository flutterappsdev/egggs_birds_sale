...
class DmDetails extends StatefulWidget {
  static const String id = 'DmDetails';
  @override
  _DmDetailsState createState() => _DmDetailsState();
}

class _DmDetailsState extends State<DmDetails> {
  var dmdata = {};
        ...
        child: Column(
          ...
          children: [
            ...
            RoundButton(
              color: Colors.red,
              onPressed: () {
                Navigator.of(context).pushNamed(PdfDm.id, arguments: {
